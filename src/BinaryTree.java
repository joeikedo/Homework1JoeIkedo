...
public class BinaryTree<E> implements Serializable {
    ...
    /**
     * Method to find the integer height of a tree. Does so by finding the "lowest" node recursively.
     *
     * @param inputNode The base root of the entire tree.
     * @return The integer which represents the height of the tree.
     */
    int getHeight(Node<E> inputNode){
        if(inputNode == null){
            return 0;
        }
        else {
            int leftTree = getHeight(inputNode.left);
            int rightTree = getHeight(inputNode.right);
    ...
    /**
     * Method to return the base root of the whole tree. This method is important for the Driver2.java class to have
     * since the base root must be passed as parameter when calling the getHeight() method.
     *
     * @return A Node<E> which is the root of the whole tree.
     */
    Node<E> getRoot(){
        return root;
    }
